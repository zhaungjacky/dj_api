from api.comment.serializers import CommentSerializer, CommentCreateSerializer
...
class CommentListView(
    ...
    def get(self, request, *args, **kwargs):
        ...
        # elif kwargs.get("lists"):
        #     # print(kwargs)
        #     self.queryset = ALL_COMMENTS_QUERYSET
        # else:
        #     raise BadRequest()
...
class CommentPostUUIDView(
    ...
    def get(self, request, *args, **kwargs):
        ...
        # return self.retrieve(request, *args, **kwargs)
        return Response({"body":str(self.queryset[0])})
